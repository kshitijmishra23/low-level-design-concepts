...
public class EmployeeClient {
  ...
  public List<Employee> getEmployeeList() {
    ...
    EmployeeAdaptorLdap employeeAdaptorLdap = new EmployeeAdaptorLdap(employeeFromLdap);
    EmployeeAdaptorCSV employeeAdaptorCSV = new EmployeeAdaptorCSV(employeeFromCSV);
    employees.add(employeeFromDB);
    employees.add(employeeAdaptorCSV);
